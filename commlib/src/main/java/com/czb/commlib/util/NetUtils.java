...
//        if (android.os.Build.VERSION.SDK_INT > 10) { always >=15
...
//        }
    ...
    public static boolean isConnected() {
        NetworkInfo info = getActiveNetworkInfo(Utils.getContext());
    ...
    public static boolean isGpsOpen() {
        LocationManager locationManager = (LocationManager) Utils.getContext().
    ...
    private boolean isWifiProxy(Context context) {
        ...
        if (IS_ICS_OR_LATER) {
            ...
            proxyAddress = android.net.Proxy.getHost(applicationContext);
            proxyPort = android.net.Proxy.getPort(applicationContext);
        }
